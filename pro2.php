...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li class="active"><a href="pro2.php">Check List<img src="assets/img/view2.png"></a></li>
                                  <li><a href="pro3.php">Edit Student<img src="assets/img/view2.png"></a></li>
                                  <li ><a href="#"><font color="red"><i>You are about to promote students in D [<?php echo $_GET['id'] ;   ?>] </i></font><img src="assets/img/promote.png"></a></li>
                                </ul>
                            <br>
...
<!--*************this is javascript codes to check all. it works in chrome and IE9 -->
...
<!--*************this is the end of javascript codes to check all-->
...
$result = mysqli_query("SELECT * FROM studentstable WHERE course_id='$id'");
?>
...
<tr class="listheader">
<td>Check all<br><input type="checkbox" onClick="toggle(this)"  ><br/></td>
<td>Student ID</td>
<td>Sir Name</td>
<td>First Name</td>
<td>Last Name</td>
...
<td><input type="checkbox" name="users[]" value="<?php echo $row["student_id"]; ?>" ></td>
...
<td><?php echo $row["feepayable"]; ?></td>
<td><?php echo $row["county_id"]; ?></td>
<td><?php echo $row["constituency_id"]; ?></td>
...
?>
<tr class="listheader">
<td colspan="4"><input type="button" name="update" value="Promote" onClick="setUpdateAction();" />
