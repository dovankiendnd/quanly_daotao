...
<!--****************************************************************************-->
                   <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  <li ><a href="expences.php">New Expence<img src="assets/img/new.png"> </a></li>
                                  <li class="active"><a href="viewexpence.php">View captured expences<img src="assets/img/update2.png"> </a></li>
                                </ul>
                            <br>
            ...
            <div class="container-fluid">
                ...
                <nav>             
                        ...
                        <div id="block_bg" class="block">   
                            ...
                            <table>
                            <tr>
                            <td><label>Search using Description/Purpose</label></td>
                            <td><input type="text" name="myInput" id="myInput" class="form-control"
                             placeholder="Description" onkeyup="myFunction()"></td>
                             <td><label>Date</label></td>
                             <td><input type="text" name="myInput2" id="myInput2" class="form-control"
                             placeholder="Date" onkeyup="myFunction2()"></td>
                             <td>
                               <input type="submit" value="Print" name="" class="form-control">
                             </td>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="myTable">
                                        ...
                                        <thead>
                                          <tr>
                                                ...
                                                <th><center>E. Date</center></th>
                                                <th><center>Description</center></th>
                                                <th><center>Amount</center></th>
                                                <th><center>Captured By</center></th>
                    ...
                    $sql ="SELECT   expence_id, expence_date, description, expence_amount, captured_by from expence ORDER BY expence_date DESC";
                    $user_query=mysqli_query($db,$sql) or die("error getting data");
                    while($row = mysqli_fetch_array($user_query)){
                    $id = $row['expence_id'];
                    //$totalfinal=$row['SUM(expence_amount)']; 
                        ...
                        ?>
                                                ...
                                                <td><center><?php echo $row['expence_id']; ?></center></td>
                                                <td><center><?php echo $row['expence_date']; ?></center></td>                       
                                                <td><center><?php echo $row['description']; ?></center></td>
                                                <td><center><?php echo $row['expence_amount'] ?></center></td>
                                                <td><center><?php echo $row['captured_by']; ?></center></td>
                                            
                                                <td>
                                                <center><a href="#" <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-delete"></i>Delete</a></center></td>
