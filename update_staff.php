  ...
  include('connect.php');
    if (isset($_POST['register'])){
                ...
                $sql2="UPDATE `staff` SET `sirname`='$sirname',`firstname`='$firstname',`lastname`='$lastname',`idno`='$idno',`dateofbirth`='$dateofbirth',`gender`='$gender',`mobile`='$mobile',`email`='$email',`address`='$address',`zipcode`='$zipcode',`doa`='$doa',`kra`='$kra',`nssf`='$nssf',`nhif`='$nhif',`roles`='$roles',`department_id`='$department_id' WHERE `staff_id`=$staff_id"; 
