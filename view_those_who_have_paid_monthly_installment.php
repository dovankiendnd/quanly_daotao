...
<!--****************************************************************************-->
                          <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li class="active"><a href="view_those_who_have_paid_monthly_installment.php">
                                  View school fees<img src="assets/img/export.png"></a></li>
...
<h4><center><h4><strong>View </strong></h4></center></h4>
                ...
                <div class="row">
                    <div class="col-sm-3">
                     ...
                     <div class="col-sm-6" >
                        ...
                        <form method="get" action="reports_all/month_fee.php">
                        <!--consider using pdf.php for the entire print out of fee paid-->

                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">  
                                     
                                        <tr>
                                        <td> <label>From [Start Date]</label></td>
                                        <td> <label>To [End Date]</label></td>
                                        </tr>
                                        <tr>                                        
                                        <td><input type="date" name="date1" class="form-control" value="<?php echo date('d-m-Y')  ;   ?>"></td>
                                        <td><input type="date" name="date2" class="form-control" value="<?php echo date('d-m-Y')  ;   ?>"></td>
                                        <input type="hidden" name="currentuser" class="form-control"
                                         value="<?php echo $_SESSION['fname']  ; ?>">
                                        <tr>
                                        
                                        <tr>
                                            <td>
                                            <input type="submit" name="submit" value="Generate" /><br></td>
                                        </tr>                                       
                                    </table>
                                </form>
