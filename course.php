...
mysqli_query($conn,"INSERT INTO course(department_id,coursename,exambody,duration,feepayable ) VALUES ('$department_id','$coursename','$exambody','$duration','$feepayable')") or die(mysqli_error());
