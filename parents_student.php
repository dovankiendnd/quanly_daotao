...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                <li ><a href="parents.php">View Parents<img src="assets/img/view2.png"></a></li>
                                  <li class="active"><a href="parents_student.php">Student <img src="assets/img/new.png"> </a></li>
            ...
            <div class="container-fluid">
                ...
                <nav>
                        ...
                        <div id="block_bg" class="block">   
                            ...
                            <table>
                            <tr>
                            <td><a button type='button' class="btn btn-primary" href="parents.php"><--</a></td>
