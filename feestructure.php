...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  <li ><a href="feestudents.php">Recieve Fee<img src="assets/img/new.png"> </a></li>
                                  ...
                                  <li class="active"><a href="feestructure.php">Print Fee Structure<img src="assets/img/print.png"> </a></li>                        
...
<h4><center><h4><strong>Edit the fields to suit your need</strong></h4></center></h4>
                     ...
                     <div class="col-sm-6" >
                        ...
                        <form method="get" action="pdf.php">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">                                      
                                        <tr>
                                            <td>
                                                <label>Enter admission number to Payments made</label>
                                            
                                                <input type="text" name="payment" class="form-control">
                                            </td>                                            
                                        </tr> 
                                        <tr>
                                            <td><u><i>You may customize the fileds below (Optonal to be activated on request)</i></u></td>
                                        </tr>
                                        <td>General Comment<input type="text" name="term" class="form-control"></td>
                                        <td>Opening date<input type="date" name="od" class="form-control"></td></tr>
                                        <tr>
                                        <td>Include payment details<input type="checkbox" name="od" class="form-control" ></td>
                                        <tr></i>
