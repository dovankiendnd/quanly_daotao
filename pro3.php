...
mysqli_query("UPDATE studentstable set course_id='" . $_POST["course_id"][$i] . "' WHERE student_id='" . $_POST["student_id"][$i] . "'");
}
...
$result = mysqli_query("SELECT * FROM studentstable WHERE student_id='" . $_POST["users"][$i] . "'");
