...
<!--******************************Second tab section**********************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li class="active"><a href="csvfee.php">Import/Export CSV<img src="assets/img/export.png"></a></li> 
    ...
    <div id="wrap">
        <div class="container">
            <div class="row">
                ...
                <form class="form-horizontal" action="feefunctions.php" method="post" name="upload_excel" enctype="multipart/form-data">
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-4">
                                <button type="submit" id="submit" name="Importfee" class="btn btn-primary button-loading" data-loading-text="Loading...">Import</button>
                            </div>
                        </div>
...
<div>
    <form class="form-horizontal" action="feefunctions.php" method="post" name="upload_excel"   
                      enctype="multipart/form-data">
            <div class="form-group">
                    <div class="col-md-4 col-md-offset-4">
                        <input type="submit" name="Exportfee" class="btn btn-success" value="export to excel"/>
                    </div>
            </div>                    
    </form>           
 </div>
