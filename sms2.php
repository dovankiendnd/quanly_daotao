...
<!--*******************************Sub menu*************************************************-->
                    <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  <li><a href="sms.php">Type contacts <img src="assets/img/new.png"> </a></li>
                                  <li  class="active"> <a href="sms2.php">Upload CSV file<img src="assets/img/view2.png"></a></li>
                                </ul>
                            <br>
        ...
        <div class="col-sm-6">
            <div>
                <form action="readcsv.php" method="POST">
                    ...
                    <label>Upload contacts from a CSV file<a href="whatiscsv"><i>How to create CSV file</i></a></label>
