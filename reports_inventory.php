...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li class="active"><a href="reports_inventory.php">Reports<img src="assets/img/report2.png"> </a></li>  
                                </ul>
                            <br>
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="panel panel-primary">
                        ...
                        <form action="inventory.php" method="POST" enctype="multipart/form-data">
                                ...
                                <a href="reports_all/all_assets_reports.php">All Assets[Acitve and Disposed]</a> <br>
                                <a href="reports_all/active_assets_reports.php">Active Assets</a><br>                           
                                <a href="reports_all/disposed_assets_reports.php">Disposed Assets</a><br>
                                
                                [Reports to added on request]                          
                        </form>
