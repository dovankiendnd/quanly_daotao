...
<div style="
    ...
    width: 100%;
    height: 150px;">
    <h2><img src="assets/img/logo.png">School Management System
    <div style="float:right; font-size:20px;text-align:right;">
    <img src="assets/img/mail2.png">Email: info@jmax.ac.ke<br>
    <img src="assets/img/call1.png">Contact:+254729734768<br>
    <img src="assets/img/location.png">Location: gituamba plaza, Ruiru town
    </div> 
   </h2>
</div>
<?php
...
mysqli_query($conn,"UPDATE `trial` SET `idno`='idno',`fname`='fname',`lname`='lname',`salary`='salary] WHERE idno=1");   
                }
            }
    ?>
               </div>
