...
if (isset($_POST['delete'])){
    ...
    $del=$_POST['department'];

    $sql="DELETE FROM departments WHERE department_id='$del'";
    mysqli_query($db,$sql);  
    if ($sql){            
     echo '<script>
            alert("Record Succsessfully deleted!!");
...
<!--****************************************************************************-->
                        ...
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li class="active"><a href="deletedepartment.php">Delete<img src="assets/img/view2.png"></a></li>
                                </ul>
                            <br>
...
<h4><center><h4><strong>Select Department to delete</strong></h4></center></h4>
                        ...
                        <form method="POST" action="deletedepartment.php">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="text" name="department" class="form-control" value="<?php echo $id ; ?>">
                                            </td>
                                            <tr>
                                                <td colspan="2"><input type="submit" name="delete" value="Delete" class="btn btn-primary" ></td>
                                            </tr>
                                            </tr>
                                    </table>
                                </form>
