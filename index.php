    ...
    <h2>
            ...
            $num_rows=mysqli_num_rows($result);
             while($row=mysqli_fetch_assoc($result))
                    ...
                    ?>
                    <?php 
                    echo isset($cname) ? $cname : '';
                    ?>

    <div style="float:right; font-size:20px;text-align:right;">
    
    <img src="assets/img/mail2.png">Email: <?php  echo isset($cemail)? $cemail : ''; ?><br>
    <img src="assets/img/call1.png">Contact:<?php  echo isset($ccontact) ? $ccontact : ''; ?><br>
    <img src="assets/img/location.png">Location: <?php  echo isset($clocation ) ? $clocation : ''; ?>
