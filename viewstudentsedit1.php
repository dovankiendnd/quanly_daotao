...
<?php
                        ...
                        $records2=mysqli_query($conn,$db,$query);
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    ...
                    <form action="update.php" method="POST" enctype="multipart/form-data">                         
                        ...
                        <select id="gender" name="gender" value="<?php echo $gender?>" class="form-control">  
                                            <option></option>
                                                <?php 
                                                    $query=mysqli_query($conn,"select * from genderset");
                                                    while($row=mysqli_fetch_array($query))
                                                     { 
                       ...
                       <!--  <label>Country</label>
                        ...
                        <select id="constituency_id" name="constituency_id" value="<?php echo $constituency_id?>" class="form-control">  
                                            <option></option>
                                                <?php 
                                                    $query=mysqli_query($conn,"select * from constituency");
                                                    while($row=mysqli_fetch_array($query))
                                                     { 
                        ...
                        <input type="text" name="zipcode" value="<?php echo $zipcode?>" class="form-control"> 
                         ...
                         <input type="date" name="reg_date" required value="<?php echo $reg_date; ?>" class="form-control" >
                        ...
                        <input type="hidden" id="border" name="border" value="<?php echo $border?>"" class="form-control">
