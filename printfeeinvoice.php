...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li class="active"><a href="printfeeinvoice.php">Print Invoice<img src="assets/img/print.png"> </a></li>
                                  <li ><a href="view_those_who_have_paid_monthly_installment.php">View school fees<img src="assets/img/export.png"></a></li>
...
<h4><center><h4><strong>Generate Invoice</strong></h4></center></h4>
                ...
                <div class="row">
                    <div class="col-sm-3">
                     ...
                     <div class="col-sm-6" >
                        ...
                        <form method="get" action="reports_all/year_specified_invoice_per_student.php">
                        <!--consider using pdf.php for the entire print out of fee paid-->

                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">                                      
                                        <tr>
                                            <td>
                                                <label>Enter admission to generate invoice[This will print invoice for the current year]</label>
                                                <?php
                                        ...
                                        <tr>
                                            <td>
                                                ...
                                                <?php                                                                                                                                                
                                                $sql2="SELECT * FROM course where course_id>0 and course_id<5 ";
                                                ...
                                                while($users2=mysqli_fetch_array($records2))
                                                        {
                                                            echo "<option>".$users2['course_id']."</option>";
                                                        }
                                        ...
                                        <td>Additional notes to be refrected on the invoice (optional)
                                            <textarea rows="5" name="add" class="form-control" placeholder="Additional Note">
