...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  <li class="active"><a href="#">New Asset<img src="assets/img/new.png"> </a></li>  
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="panel panel-primary">
                        ...
                        <form action="inventory.php" method="POST" enctype="multipart/form-data">
                            ...
                            <label>Asset code/Name [<font color="red">*</font>]</label>
                            <input type="text" name="asset_code" class="form-control">
                            <label>Date Purchased [<font color="red">*</font>]</label>
                            <input type="DATE" name="date_purchased" class="form-control" value="<?php echo date('Y-m-d'); ?>">
                            <label>Estimated_value</label>
                            <input type="number" name="estimated_value" class="form-control">
                            <label>location</label>
                            <input type="text" name="location" class="form-control">
                            <label>model_make</label>
                            <input type="text" name="mode_make" class="form-control">
                            ...
                            <input type="text" name="updated_by" readonly class="form-control" value=<?php echo $currentuser; ?>>                            
                                                                     
                              <input type="submit" name="register" value="Add Asset"  class="btn btn-success" ><br><br>
...
<?php
    ...
    if (isset($_POST['register'])){        
        ...
        $active="yes";
        $reason_for_disposing="";
        $updated_by=$_POST['updated_by'];
        
     mysqli_query($conn,"INSERT INTO `inventory`(`asset_code`, `date_purchased`, `estimated_value`, `location`, `mode_make`, `purchase_price`, `serial_number`, `asset_condition`, `quantity`, `order_number`, `active`,`reason_for_disposing`, `updated_by`) VALUES ('$asset_code','$date_purchased','$estimated_value','$location','$mode_make','$purchase_price','$serial_number','$asset_condition','$quantity','$order_number','$active','$reason_for_disposing','$updated_by')") or die(mysqli_error());
...
?>
                        ...
                        window.location = "inventory.php?id=<?php echo $id;?>";
                        </script>
<?php
