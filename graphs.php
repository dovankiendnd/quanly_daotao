...
<div style="width:30%; background-color:skyblue; text-align:center">Graphical analysis. Number of students in every class</div>

  <div id="chartContainer" style="height: 200px; width: 30%; border:2px solid green"></div><br><br>
