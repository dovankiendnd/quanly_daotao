...
<h4><center><h4><strong>View students according to their respective Courses</strong></h4></center></h4>
                        ...
                        <form method="post">
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                        <tbody>
                                        <?php
                                                    $sql="SELECT * FROM course WHERE course_id!=5 AND course_id!=6";
                                         ...
                                         ?>
                                                ...
                                                <center><a button class="btn btn-success" title="Click here to View."
                                                 href="markstep2.php<?php echo '?id='.$row['course_id'];?>">View Students</a></center></td>
                                                 <td >
                                                <center><a button class="btn btn-success" title="Click here to View."
                                                 href="viewstudents.php<?php echo '?id='.$row['course_id'];?>">Amend Details</a></center></td>
                                            </center>
