...
<?php
                        ...
                        while($rec=mysqli_fetch_assoc($records2))
                        {
                        ...
                        <div class="panel-body">
                          ...
                          <form action="fee.php" method="POST" enctype="multipart/form-data">
                              ...
                              <label>Admmission number:</label>
                               ...
                               <label>Term:</label>
                               <select id="an" name="term_id"  class="form-control">
                                 <option>1</option>
                                 <option>2</option>
                                 <option>3</option>
                                 <option>4</option>
                               ...
                               <label>Date:</label>
                               <input type="date"  id="d" name="tdate" value="<?php echo date("Y-m-d") ;?>" class="form-control">
                                
                                REF #:[IN THE FORM <I><b>MONTH/YEAR/RECIEPT NO.</b></I>]
                               <input type="text" id="an" name="refno" placeholder="e.g LD125YZ. Can also be reciept number in the manual record. e.g 4510" class="form-control"
                  ...
                  <?php
                    ...
                    $totalpaid= $row['value_sum'];
                               ...
                               <input type="number" name="totalpaid" id="an" readonly class="form-control" value="<?php echo $totalpaid; ?>"></td>
                                ...
                                <td>[Remaining Balance]</td><td><input type="number" id="an" name="feepayable" readonly class="form-control"  value="<?php echo $balance; ?>"></td>
...
<?php
    ...
    $xx=$_POST['course_id'];
        ...
        $course_id = $row['course_id'];
         ...
         mysqli_query($conn,"INSERT INTO fee (method, refno, admission_number, tdate, course_id, term_id, amount,captured_by)
          VALUES ('$method','$refno','$admission_number','$tdate','$course_id','$term_id','$amount','$captured_by')") or die(mysqli_error());    
