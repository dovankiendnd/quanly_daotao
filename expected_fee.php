                ...
                <nav>             
                        ...
                        <div id="block_bg" class="block">   
                            ...
                            <div style="height:auto;
                                        ...
                                        The following students are expected to pay their installment by 5th [month]
                            ...
                            <form method="post">
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="myTable">
                                        ...
                                        <tbody>
                        <?php 
//SELECT `reciept`, `method`, `refno`, `admission_number`, `tdate`, `course_id`, `term_id`, `amount`, `captured_by` FROM `fee` WHERE 1                    

                    $sql ="SELECT  * from fee WHERE tdate NOT BETWEEN X1 AND X2";
                    ...
                    $id = $row['admission_number'];
                        ...
                        ?>
                                                ...
                                                <td>
                                                <center><a href="fee.php <?php echo '?id='.$id; ?>" class="btn btn-warning"><i class="glyphicon glyphicon-ok-circle"></i>Pay</a></center></td>
                                                ...
                                                <td><center><a href="printfeeinvoice.php <?php echo '?id='.$id; ?>" class="btn btn-info"><i class="glyphicon glyphicon-print"></i>Print Invoice</a></center></td>
