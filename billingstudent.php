...
<!--end of heading section-->  
 ...
 <div style="float:left;"></div></div><div style="float:right;">Current User: <font color="orange">John</font>  <a href="xxx">Log Out<img src="assets/img/logout.png"></a></div><hr>
...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li class="active"><a href="billingstudent.php">Billing </a></li>
  ...
  <!--*************************************************************************************************************************-->
                        <table class="table table-hover" >
                            <tr><td colspan="3" style="height:0.2px;"><h4>Student Biling/ Invoices</h4></td></tr>
                            <tr>
                            <td>Sir name<input type="text" name=""> Firstname Name<input type="text" name=""> Last Name<input type="text" name="">
                                  ID/Passport NO.<input type="text" name=""><br><br>Date of Birth<input type="date" name="">
                                  Gender <select name="gender"> 
                                                  <option value="male">Male</option>
                                                  <option value="female">Female</option>
                                          </select> 
                                          Country<input type="text" name=""> County<input type="text" name=""> Town<input type="text" name="">
                                  
                            </td></tr>
                             <tr><td style=" height:0.2px;"><h4>Contact Details</h4></td></tr>
                            <tr ><td>
                                
                                Mobile&nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name=""> Email<input type="email" name=""> 

                                Address<input type="text" name="">
                                Zip Code <input type="text" name="">

                            </td></tr>
                             <tr><td style="height:0.2px;"><h4>Guardian/Parent and other Details</h4></td></tr>
                            <tr><td>
                                
                                Sir name&nbsp;&nbsp;<input type="text" name=""> Firstname Name<input type="text" name=""> Last Name<input type="text" name=""><br><br>

                                      Mobile &nbsp;&nbsp;&nbsp;&nbsp;<input type="number" name="">Relationship &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="">
                                      

                            </td></tr>
                            <tr><td>
                           <font color="orange" size="4"> Course Applied &nbsp;&nbsp;&nbsp;&nbsp;<select name="">
                                                    <option value="male">Information Technology</option>
                                                    <option value="female">Business Management</option></select>
                                    Assign Adm. No. &nbsp;&nbsp;&nbsp;&nbsp;<input type="text" name="">
                                    Assign  Class/Intake &nbsp;&nbsp;&nbsp;&nbsp;<select name="">
                                                    <option value="male">Sep2017</option>
                                                    <option value="female">Dec2017</option></select>
                                    </font>
