...
$id = $_GET['id'];
    $select = "SELECT * FROM 
            inventory WHERE asset_id=$id";
             $result = mysqli_fetch_array(mysqli_query($select));
...
<!--this is the heading section-->   
    <h2>
            <?php
            $query=mysqli_query("select * from companyinfo");
...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li class="active"><a href="edit_inventory.php">Edit<img src="assets/img/edit2.png"> </a></li>  
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="panel panel-primary">
                        ...
                        <form action="update_inventory.php" method="POST" enctype="multipart/form-data">
                            ...
                            <input type="text" name="asset_code" class="form-control" readonly value="<?php echo $asset_code?>">
                            <label>Date Purchased [<font color="red">*</font>]</label>
                            <input type="DATE" name="date_purchased" class="form-control" value="<?php echo $date_purchased?>">
                            <label>Estimated_value</label>
                            <input type="number" name="estimated_value" value="<?php echo $estimated_value?>" class="form-control">
                            <label>location</label>
                            <input type="text" name="location" class="form-control" value="<?php echo $location?>">
                            <label>model_make</label>
                            <input type="text" name="mode_make" class="form-control" value="<?php echo $mode_make?>">
                            ...
                            <input type="text" name="asset_condition" class="form-control" value="<?php echo $asset_condition?>">
                            <label>quantity</label>
                            <input type="number" name="quantity" class="form-control" value="<?php echo $quantity?>">
                            <label>order_number</label>
                            <input type="number" name="order_number" class="form-control" value="<?php echo $order_number?>">                            
                            <input type="hidden" name="active" class="form-control" value="<?php echo $active?>">                     
                            <input type="hidden" name="reason_for_disposing"  class="form-control" value="">
                            <label>updated_by</label>
                            <input type="text" name="updated_by" readonly class="form-control" value="<?php echo $currentuser?>"><br>                            
