    ...
    <div class="container-fluid">
       <div class="row">
            <div class="col-lg-6 col-lg-offset-3">
                ...
                <form action="markstep3.php" method="POST" enctype="multipart/form-data">
                     <div style="float:left; position:relative">  
                        ...
                        <td>
                            <select name="admission_number" class="form-control browser-default" id="admission_number">
                                <option value="" disabled="" <?php echo empty($id) ? "selected" : '' ?>> Select Here</option>
                                <?php
                                $students = mysqli_query($conn,"SELECT *,concat(firstname,' ',lastname) as name FROM studentstable order by concat(firstname,' ',lastname) asc ");
                                while($row=mysqli_fetch_assoc($students)):
                                ?>
                                <option value="<?php echo $row['admission_number'] ?>" data-course='<?php echo $row['course_id'] ?>' <?php echo !empty($id) && $id == $row['admission_number'] ? "selected" : '' ?>><?php echo ucwords($row['name']) ?></option>
                            <?php endwhile; ?>
                            </select>
                            <input type="hidden" name="course_id"  value="<?php echo $course_id?>" class="form-control">
                        </td> 
                        <tr/>
                        <tr>
                    ...
                    <h4><font color="green">Subjects</font></h4>
                             ...
                             <table><tr>
                            <td><label>FBM
                            <input type="number" name="a" id="a" class="form-control"  onkeyup="final()" max="100" >
                            </td>
                            <td><label>R_SERVICE
                            <input type="number" name="b" id="b" class="form-control"  onkeyup="final()" max="100" >
                            </td></tr>

                            <tr>
                            <td><label>CT/PB
                            <input type="number" name="c" id="c" class="form-control"  onkeyup="final()" max="100" >
                            </td>
                            <td><label>FOOD_SCIENCE
                            <input type="number" name="d" id="d" class="form-control"  onkeyup="final()" max="100" >
                            </td></tr>

                            <tr>
                            <td><label>FUNDAMENTALS
                            <input type="number" name="e" id="e" class="form-control"  onkeyup="final()" max="100" >
                            </td>
                            <td><label>FRONT_OFFICE
                            <input type="number" name="f" id="f" class="form-control"  onkeyup="final()" max="100" >
                            </td></tr>

                            <tr>
                            <td><label>COMUNICATION_SKILLS
                            <input type="number" name="g" id="g" class="form-control"  onkeyup="final()" max="100" >
                            </td>
                            <td><label>COSTING
                            <input type="number" name="h" id="h" class="form-control"  onkeyup="final()" max="100" >
                            </td></tr>

                            <tr>
                            <td><label>HOUSEKEEPING
                            <input type="number" name="i" id="i" class="form-control"  onkeyup="final()" max="100" >
                            </td>
                            <td><label>FOOD & BEVERAGE PRACTICAL
                            <input type="number" name="j" id="j" class="form-control"  onkeyup="final()" max="100" >
                            </td>
                           </tr>
...
mysqli_query($conn,"INSERT INTO
 marks(
    admission_number, course_id, term, year, exam_series, FBM, R_SERVICE, CT_PB, FOOD_SCIENCE, FUNDAMENTALS, FRONT_OFFICE, COMUNICATION_SKILLS, COSTING, HOUSEKEEPING, FB_PRACTICAL, average )
     VALUES
      ('$admission_number','$course_id','$term','$year','$exam_series','$a','$b','$c','$d','$e','$f','$g','$h','$i','$j'
      ,'$average')") or die(mysqli_error());
?>
<?php 
