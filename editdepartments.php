...
<!--**************************************************************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li class="active"><a href="editdepartments.php">Edit Department<img src="assets/img/update2.png"> </a></li>
       ...
       <div class="row">
                <div class="col-lg-6 col-lg-offset-3">
                    ...
                    <form action="updatedepartment.php" method="POST" enctype="multipart/form-data">                         
                        ...
                        <input type="hidden" name="department_id"   value="<?php echo $id; ?>" class="form-control"> 

                        <label>Department name</label>
                        <input type="text" name="departmentname"  value="<?php echo $departmentname ;?>" class="form-control">

                        <label>HOD</label>
                        <input type="text" name="hod" value="<?php echo $hod?>" class="form-control">

                       
                        <input type="submit" name="register" value="Update" class="btn btn-success">
                        <a button type='button' class="btn btn-primary" href="departments.php">Back</a> <br><br>                           
                       </div> 
                       </form>
                </div>
</div>
