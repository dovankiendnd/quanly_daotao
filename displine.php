...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  <li class="active"><a href="displine.php">Record New Case <img src="assets/img/new.png"> </a></li>
                                  <li><a href="#">Student's case summary<img src="assets/img/update2.png"> </a></li>
                                  <li><a href="#">Import/Export CSV<img src="assets/img/delete2.png"></a></li>
                                  <li><a href="#">Delete<img src="assets/img/view2.png"></a></li>
                                </ul>
                            <br>
       ...
       <div class="row">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="panel panel-primary">
                        <div class="panel-heading">Record Case</div>
                        ...
                        <div class="panel-body">
                          ...
                          <form action="displine.php" method="POST" enctype="multipart/form-data">
                          <h4>Department Details</h4>                            
                                                                                                  
                            <label>Student ID.</label>
                             <select name="admission_number" class="form-control" >  
                                                  <?php
                                                
                                              include('connect.php');
                                                $sql1="SELECT * FROM studentstable";
                                                $records1=mysqli_query($db,$sql1);
                                                    while($row=mysqli_fetch_array($records1))
                                                        {
                                                            echo "<option>".$row['admission_number']."</option>";
                                                        }
                                                ?>
                                          </select> 
                            <label>Date </label>
                            <input type="date" name="date_c" class="form-control" required value="date('d-m-Y')>

                            <label>Displinary Case</label>
                            <textarea rows="4" cols="10" name="displine_case" class="form-control"></textarea>
...
<!--****************************************************************************-->
  ...
  <?php
    ...
    if (isset($_POST['register'])){
        ...
        $date_c=$_POST['date_c'];
        $displine_case=$_POST['displine_case'];

    
     mysqli_query($conn,"INSERT INTO displinary_case(admission_number,date_c, displine_case) VALUES ('$admission_number','$date_c','$displine_case')") or die(mysqli_error());
   

?>
                        <?php 
                        $query="SELECT * FROM displinary_case";
                        ...
                        window.location = "displine.php?id=<?php echo $id;?>";
                        </script>
<?php }?> 
