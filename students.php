                              ...
                              <!--   <label>Country</label>
                               ...
                               <!--  <label>Status</label>
                                <select name="border" required class="form-control">
                                                ...
                                                ?></select>
                                                NB:Additional charges to all borders
                                </div>     -->                           
...
<?php
    ...
    //<!--**************************************************************>
     ...
     mysqli_query($conn,"INSERT INTO studentstable(admission_number, sirname, firstname, lastname, idno, dateofbirth, gender, country_id, county_id, constituency_id, mobile, email, address, zipcode, course_id, border,reg_date, feepayable, emergency_contact)
      VALUES ('$admission_number','$sirname','$firstname','$lastname','$idno','$dateofbirth','$gender','$country_id','$county_id','$constituency_id','$mobile','$email','$address','$zipcode','$course_id','$border','$reg_date','$finalfee','$emergency_contact')") or die(mysqli_error());
     mysqli_query($conn,"INSERT INTO parents(admission_number, psirname, pfirstname, plastname, pmobile, prelationship)
