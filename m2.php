...
<!--****************put the academic perfomance codes here**********-->
            ...
            <!--Displaying the data************************************************************************************-->
                                        ...
                                        $sql ="SELECT  course_id,admission_number,term,year,maths,english,kiswahili,social_studies,science, average,
...
<!--****************************************************************************-->
  ...
  <?php
    ...
    if (isset($_POST['register'])){
     ...
     mysqli_query($conn,"INSERT INTO displinary_case(admission_number,date_c, displine_case)
      VALUES ('$admission_number','$date_c','$displine_case')") or die(mysqli_error());
