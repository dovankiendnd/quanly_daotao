...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  <li class="active"><a href="pro1.php">Choose Class <img src="assets/img/new.png"> </a></li>
...
<h4><center><h4><strong><font color="orange">View students according to their respective Courses/Classes</strong></h4></center></h4>
                        <?php
                        include("connect.php"); 
                        ?>
                        <form method="post">
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="example">
                                        ...
                                        <?php
                                         ...
                                         ?>
                                                ...
                                                <td><strong><?php echo $row['coursename']; ?><strong></td>
                                            
                                                <td >
                                                <center><a button class="btn btn-danger" title="Click here to View."
                                                 href="pro2.php<?php echo '?id='.$row['course_id'];?>">Promote</a></center></td>
                                            </center>
