...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li  class="active"><a href="dispose_inventory.php">Dispose/ Write off<img src="assets/img/dispose.png"> </a></li>  
               ...
               <div class="container-fluid">
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="panel panel-primary">
                        <div class="panel-heading">Dispose Asset. [<a href="view_disposed_assets.php"><font color="yellow">Click here to view diposed assets</font></a>]</div>
                        ...
                        <form action="update_inventory.php" method="POST" enctype="multipart/form-data">
                            ...
                            <label>Reason for disposing</label>
                            <textarea name="reason_for_disposing"  class="form-control">
    
                            </textarea>

                            <input type="hidden" name="active" class="form-control" value="no"> 
