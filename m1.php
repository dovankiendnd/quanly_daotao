...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  <li class="active"><a href="m1.php">Students list[Admissions] <img src="assets/img/new.png"> </a></li>
                                  <li><a href="m2.php">History<img src="assets/img/update2.png"> </a></li>
                                </ul>
                            <br>
       ...
       <div class="row">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="panel panel-primary">
                        <div class="panel-heading">Select Student ID to view history</div>
                        ...
                        <div class="panel-body">
                          ...
                          <form action="m2.php" method="GET" enctype="multipart/form-data">
                          <h4>Department Details</h4>                            
                            ...
                            <br>
                             <input type="submit" name="register" value="View History" class="btn btn-success">
