...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  <li class="active"><a href="expences.php">New Expence<img src="assets/img/new.png"> </a></li>
                                  <li><a href="viewexpence.php">View captured expences<img src="assets/img/update2.png"> </a></li>
                                </ul>
                            <br>
       ...
       <div class="row">
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="panel panel-primary">
                        <div class="panel-heading">Add new Expence</div>
                        ...
                        <div class="panel-body">
                          ...
                          <form action="expences.php" method="POST" enctype="multipart/form-data">
                          <h4>Expence Details</h4>
                            
                            <label>Date</label>
                            <input type="date" name="expence_date" class="form-control" value="<?php echo date('Y-m-d'); ?>">
                            ...
                            <label>Amount</label>
                            <input type="number" name="expence_amount" class="form-control">                                                                      
                            <label>Captured by</label>
                            <input type="text" name="captured_by" readonly class="form-control" value=<?php echo $currentuser; ?> ><br>
  ...
  <?php
    ...
    if (isset($_POST['register'])){
        ...
        $captured_by=$_POST['captured_by'];
         ...
         mysqli_query($conn,"INSERT INTO expence(expence_date, description, expence_amount,captured_by) VALUES ('$expence_date','$description','$expence_amount','$captured_by')") or die(mysqli_error());
...
?>
                        ...
                        window.location = "expences.php?id=<?php echo $id;?>";
                        </script>
<?php }?> 
