  ...
  include('connect.php');
    if (isset($_POST['register'])){
                ...
                $sql2="UPDATE `studentstable` SET `sirname`='$sirname',`firstname`='$firstname',`lastname`='$lastname',`idno`='$idno',`dateofbirth`='$dateofbirth',`gender`='$gender',`mobile`='$mobile',`email`='$email',`address`='$address',`zipcode`='$zipcode',
                `course_id`='$course_id',`border`='$border',`reg_date`='$reg_date',`feepayable`='$feepayable' 
                WHERE `admission_number`='$admission_number'"; 
