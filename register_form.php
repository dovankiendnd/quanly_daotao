...
<!--**************************************************************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  <li class="active"><a href="register_form.php">New user <img src="assets/img/new.png"> </a></li>
                                  <li><a href="manage_account.php">View users<img src="assets/img/view2.png"></a></li>
...
<div class="col-sm-6" >
                                  <form method="POST" action="register_form.php">     
                                     <div class="form-group">
                                        ...
                                        <div class="form-group">
                                         ...
                                         <div class="form-group">
                                            <select name="role" id="role" class="form-control" placeholder="roles" required>
                                                <option>adm</option>
                                                <option>tutor</option>
	...
	$query = mysqli_query("select * from admin where username = '$username' and password = '$password' and fname = '$fname' and lname = '$lname' and email = '$email' and role = '$role' ")or die(mysqli_error());
...
<?php
	...
	mysqli_query("insert into admin (fname,lname,username,password,email,role) values('$fname','$lname','$username','$password','$email','$role')")or die(mysqli_error());
