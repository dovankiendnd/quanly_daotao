...
$sql = "SELECT `asset_code`, `date_purchased`, `estimated_value`, `location`, `mode_make`, `serial_number`,`asset_condition`,  `quantity` FROM `inventory` WHERE active='no'";
...
$pdf->SetXY(100,25);
$pdf->Cell(100,5,'Inventory[Disposed Items]',0,0,'C',0);
//C MEANS CENTERED
