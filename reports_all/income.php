...
$sql = "SELECT reciept AS Reciept_No, method AS Method, refno AS Ref_No, tdate AS Tdate, amount AS Amount
 FROM fee  WHERE tdate BETWEEN '$date1' AND '$date2' ";
...
while($users5=mysqli_fetch_array($resultset5))
        {
...
$pdf->Image('C:\wamp\www\school_management_system\assets\img\logo2.png',10,5, -82);
//display the title with a border around it
$pdf->SetXY (10,5);
$pdf->SetFontSize(15);
$pdf->Cell(0,10, $cname,0,0,'C',0);
$pdf->Ln(6); //break
$pdf->Cell(0,10,'Income Statement between',0,0,'C',0);
$pdf->Ln(6); //break
...
$pdf->Ln(4); //break 
$pdf->Ln(4); //break    
$pdf->Line(0, 30, 210, 30);  //Set the line
$pdf->Ln(4); //line Break
$pdf->Ln(4); //break 
