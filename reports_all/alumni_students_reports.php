...
$sql = "SELECT student_id AS ADM_NO ,course_id AS Class, `sirname`, `firstname`, `lastname`, `dateofbirth`, `gender`, `mobile`,reg_date AS Admission_Date FROM `studentstable` WHERE course_id=5";
...
$pdf->SetXY(100,25);
$pdf->Cell(100,5,'Alumni List',0,0,'C',0);
//C MEANS CENTERED
