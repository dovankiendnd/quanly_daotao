...
$sql = "SELECT student_id AS ADM_NO ,course_id AS Class, `sirname`, `firstname`, `lastname`, `dateofbirth`, `gender`, `mobile`,reg_date AS Admission_Date FROM `studentstable` WHERE border='Border'";
...
$pdf->SetXY(100,25);
$pdf->Cell(100,5,'Borders List',0,0,'C',0);
//C MEANS CENTERED
