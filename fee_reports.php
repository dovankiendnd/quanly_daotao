...
<!--****************************************************************************-->
                        <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li ><a href="view_those_who_have_paid_monthly_installment.php">View Those who have paid fee<img src="assets/img/export.png"></a></li>
                ...
                <div class="col-lg-6 col-lg-offset-3">
                    <div class="panel panel-primary">
                        ...
                        <form action="inventory.php" method="POST" enctype="multipart/form-data">
                                ...
                                <a href="income.php">Income [Specified dates]</a> <br>
                                <a href="reports_all/staff_reports.php">Financial Statement</a> <br>
                                <a href="income_per_class.php">Income per Class</a> <br>
                                <a href="reports_all/staff_reports.php">Fee Balance</a> <br>
                                <a href="reports_all/staff_reports.php">Cleared Balances</a> <br>
                                <a href="reports_all/staff_reports.php">Total Paid by student.[Specify years] </a> <br>
