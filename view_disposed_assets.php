...
<!--****************************************************************************-->
                         <div class="container" style="width:100%">
                                ...
                                <ul class="nav nav-tabs">
                                  ...
                                  <li class="active"><a href="view_inventory.php">Disposed Items[list]<img src="assets/img/view2.png"> </a></li> 
            ...
            <div class="container-fluid">
                ...
                <nav>             
                        ...
                        <div id="block_bg" class="block">   
                            ...
                            <td><a href="view_inventory.php">View Active Assets list</a></td>
                             </tr>
                                    ...
                                    <table cellpadding="0" cellspacing="0" border="0" class="table" id="myTable">
                                        ...
                                        <thead>
                                          <tr>
                                                ...
                                                <th><center>Model/make</center></th>
                    ...
                    $sql ="SELECT  * from inventory WHERE active='no' ";
                    ...
                    $id = $row['asset_id'];
                        ...
                        ?>
                                                ...
                                                <td><center><?php echo $row['mode_make']; ?></center></td>
                                                ...
                                                <td>
                                                <center><a href="restore_assets.php <?php echo '?id='.$id; ?>" class="btn btn-success"><i class="glyphicon glyphicon-ok-circle"></i>Restore</a></center></td>
